...
Original file is located at
    https://colab.research.google.com/drive/1vVs9ntN1udcIC8ma9_XkgxliMdEmkpib

# Project Report: Anomaly Detection in Machine Sounds (DCASE 2020)

## 1. Introduction and Software Asset Context
This project implements a neural network-based anomaly detection system using the **DCASE 2020 Challenge Task 2** dataset. In industrial environments, such a system acts as a critical **software asset**.

From a Software Engineering perspective, it is well-established that **60% to 90% of total software lifecycle costs** are attributed to evolution and maintenance. Automated anomaly detection serves as a proactive maintenance tool, mitigating the impact of **urgent change requests** and slowing down **system aging** by identifying mechanical degradation before catastrophic failure occurs. This ultimately optimizes the long-term evolution costs of the industrial infrastructure.
"""
